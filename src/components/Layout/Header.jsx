...
import { Menu, Search, Filter, Plus, Sun, Bell, Settings, ChevronLast, ChevronDown } from 'lucide-react'
    ...
    <div className='bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b border-slate-200/50 dark:border-slate-700/50 px-6 py-4'>
        <div className='flex items-center justify-between'>
            ...
            <div className='flex item-center space-x-3'>
              ...
              {/* Notification */}
             <button className='relative p-2.5 rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-600 transition-colors'>
             ...
             <div className='flex items-center space-x-3 pl-3 border-l border-slate-200 dark:border-slate-700 '>
              <img src="/src/assets/avatar1.png" alt="User" className='w-8 h-8 rounded-full ring-2 ring-blue-500 '/>
              <div className='hidden md:block'>
                <p className='text-sm font-medium text-slate-500 dark:text-slate-600 '>Ric Tolorio</p>
                <p className='text-xs text-slate-500 dark:text-slate-400'>Administrtor</p>
              </div>
